...
function Book({
    ...
    return (
        <>
            ...
            />
            <div className="book-card col-lg-3 col-md-4 col-sm-6 col-12 g-3 hover-item">
                {isAdmin && (
                    <div
                ...
                <div className="book-info lower-height">
                    <h4 className="book-name center-text">{name}</h4>
                    <p className="author center-text">{author}</p>
                    {discount > 0 ? (
                        <h5 className="center-text">
                            Price: $
                            <span className="discounted red-text">{price}</span>
                    ...
                    {/* <h6 className="center-text">{discount > 0 ? 'sale off!!' : ''}</h6> */}
